        ...
        <VBox style="-fx-background-color: white;">
            <SplitPane orientation="VERTICAL" dividerPositions="0.65" VBox.vgrow="ALWAYS">
                ...
                <TabPane tabClosingPolicy="UNAVAILABLE" styleClass="industrial-tabs">
                    <Tab text="SDT LOGIC TREE">
                        <StackPane style="-fx-background-color: #F8F9F9; -fx-padding: 10;">
                             <StackPane style="-fx-background-color: white; -fx-border-color: #BDC3C7; -fx-effect: innershadow(three-pass-box, rgba(0,0,0,0.1), 10, 0, 0, 0);">
                                <WebView fx:id="nsSdtTreeWebView" />
                                <Label fx:id="nsTreePlaceholder" text="VISUALIZATION SCREEN" textFill="#BDC3C7" />
                             </StackPane>
                        </StackPane>
                    </Tab>
...
'''
path = r'src/main/resources/NeuroSymbolicTab_v2.fxml'
