...
def main():
    ...
    parser.add_argument('--dto', type=str, default='dto.rdf', help='Path to DTO file')
    parser.add_argument('--jar', type=str, default='target/dto-dss-1.0-SNAPSHOT.jar', help='Path to Java JAR')
